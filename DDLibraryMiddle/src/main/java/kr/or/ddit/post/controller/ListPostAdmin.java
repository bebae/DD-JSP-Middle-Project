...
@WebServlet("/manager/listPostAdmin.do")
public class ListPostAdmin extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<PostVO> getAllPost = service.getAllPost();
		
		request.setAttribute("listPost", getAllPost);
		
		request.getRequestDispatcher("/page/admin/postMan.jsp").forward(request, response);
	}
